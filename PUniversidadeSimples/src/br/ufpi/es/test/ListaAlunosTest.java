...
//		// Instancia de alunos
//		Aluno a1 = new Aluno("201149099", "Saulo de Társio",
...
//
//		// Intancia de alunos
//		Aluno a1 = new Aluno("201149099", "Saulo de Társio", null);
//		Aluno a2 = new Aluno("201149100", "João", "Ciência da Computação");
//		Aluno a3 = new Aluno("201149101", "Pedro", "Matemática");
//		Aluno a4 = new Aluno("201149102", "Maria", "Matemática");
//		Aluno a5 = new Aluno("201149101", "José", "Ciência da Computação");
...
//	// assertEquals("Matemática", aux1.getCurso());
//	//
...
//	//
//	// assertEquals("José", lista.get(4).getNome());
//	// assertEquals("Ciência da Computação", lista.get(1).getCurso());
//	// assertEquals("Matemática", lista.get(3).getCurso());
...
//	//
//	// /**
//	// * Testa o método de listagem quando não há alunos inseridos no
//	// repositório.
//	// * @throws Exception
//	// */
//	// @Test
...
//	//
//	// /**
//	// * testa o método que verifica se um determinado professor existe no
//	// repositório.
//	// */
//	// @Test
...
//	//
//	// /**
//	// * testa o método de listagem de todos os professores quando há algum
//	// erro.
//	// */
//	// @Test
...
//	// IFachada fachada = new Fachada();
//	// //Intancia de Turma
//	// Turma t1 = new Turma("Departamento de Computação",
//	// "Engenharia de Software I", 60);
//	// Turma t2 = new Turma("Departamento de Computação",
//	// "Engenharia de Software II", 60);
//	// Turma t3 = new Turma("Departamento de Matemática",
//	// "Cálculo Diferencial e Integral I", 90);
//	// Turma t4 = new Turma("Departamento de Matemática",
//	// "Cálculo Diferencial e Integral II", 90);
//	// Turma t5 = new Turma("Departamento de Letras", "Inglês Instrumental",
//	// 60);
//	//
//	// //Salvando alunos no repositório
...
//	//
//	// /**
//	// * testa o método que verifica se uma determinada turma existe no
//	// repositório.
//	// */
//	// @Test
...
//	// //fazendo as alterações.
//	// try {
//	// fachada.alterarTurma(1, "Cálculo Diferencial e Integral I",
...
//	// fachada.alterarTurma(2, "Cálculo Diferencial e Integral II",
//	// "Matemática Discreta");
//	// }catch (TurmaNaoExistenteException e) {
//	// e.printStackTrace();
//	// }
...
//	// Turma t5 = new Turma("Departamento de Letras", "Inglês Instrumental",
//	// 60);
//	// Turma t6 = new Turma("Departamento de Matemática", "Matemática Discreta",
//	// 60);
//	// Turma t7 = new Turma("Departamento de Matemática", "Algebra Linear", 60);
//	// Turma t8 = new Turma("Departamento de Computação",
...
//	// assertEquals("Cálculo Diferencial e Integral II",
...
//	// assertEquals("Introdução à Computação",
...
//	// try{
//	// lista1 =
//	// fachada.listarTurmasPorDepartamento("Departamento de Matemática");
//	// lista2 =
//	// fachada.listarTurmasPorDepartamento("Departamento de Computação");
