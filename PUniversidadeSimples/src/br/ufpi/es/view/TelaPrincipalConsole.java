			...
			case 1:
				while (true) {
					...
					case 3:
						try {
							System.out
									.println("Informe a matricula do aluno: ");
					...
					case 5:
						...
						try {
							...
							Aluno a2 = new Aluno(al.getMatricula(),
									al.getNome(), al.getCurso());
							a2.setIdAluno(al.getIdAluno());

							System.out
									.println("-------------- Aluno Selecionado ---------------------");
					...
					case 6:
						try {
							...
							System.out
									.println("Quantidade de alunos: " + quant);
						} catch (Exception e) {
							// TODO: handle exception
							System.out.println(e.getMessage());
						}
