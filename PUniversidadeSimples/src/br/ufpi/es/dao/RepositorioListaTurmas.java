...
public class RepositorioListaTurmas implements IRepositorioTurmas{
	...
	/**
	 * Construtor padr�o da classe Reposit�rioLista Turmas. Instancia a lista para armazenar as turmas.
	 */
	...
	/**
	 * M�todo que verifica se uma determinada turma est� na lista. A descri��o da disciplina deve ser passada como par�metro da pesquisa.
	 * @param disciplina.
	...
	/**
	 * M�todo que retorna todos a turmas inseridas na lista.
	...
	/**
	 * Informa a quantidade de turmas que est�o inseridas na lista.
	 * @return turmas.size().
	 */
	@Override
