...
public class ControladorProfessores {
	 ...
	 * @param tipo
	 */
	public ControladorProfessores(IRepositorioProfessores tipo){
	 ...
	 * @throws ProfessorNaoExistenteException 
	 */
	public void alterar(int op, String cpf, String info) throws ProfessorNaoExistenteException{	
	 ...
	 */
	public List<Turma> listarTurmaPorProfessor(Professor p) throws ProfessorSemTurmaException{
